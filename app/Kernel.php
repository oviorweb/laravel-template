...
use App\Auth\Middleware\BasicAuth;
use App\Auth\Middleware\EnsureEmailIsVerified;
use App\Auth\Middleware\RedirectIfAuthenticated;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'auth.basic.root' => BasicAuth::class,
